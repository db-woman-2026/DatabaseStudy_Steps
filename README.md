...
2. [기초 읽기 자료](docs/basic/README.md)에서 필요한 개념을 확인합니다.
3. [실습 구성](docs/lecture/course-plan.md)에서 주제별 결과와 검증 절차를 확인합니다.
4. [단계별 실습](docs/lecture/README.md)에서 코드와 쿼리를 확인합니다.
