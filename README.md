...
1. [Windows 11 환경 준비](docs/windows-11.md) <span class="print-reference" data-print-reference="true">(Database · Windows 11 x64 실습 환경 준비 · 1. Windows Terminal 설치)</span>에서 Node.js, Git, VS Code, MongoDB, mongosh를 설치합니다.
2. [기초 읽기 자료](docs/basic/README.md) <span class="print-reference" data-print-reference="true">(Database · 데이터베이스 기초 · 문서 목록)</span>에서 필요한 개념을 확인합니다.
3. [실습 구성](docs/lecture/course-plan.md) <span class="print-reference" data-print-reference="true">(Database · 데이터베이스 실습 구성 · 시작 조건)</span>에서 주제별 결과와 검증 절차를 확인합니다.
4. [단계별 실습](docs/lecture/README.md) <span class="print-reference" data-print-reference="true">(Database · 데이터베이스 단계별 실습 · 관련 자료)</span>에서 코드와 쿼리를 확인합니다.
