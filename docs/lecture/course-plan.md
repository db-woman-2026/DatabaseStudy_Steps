...
- [Windows 11 환경 준비](../windows-11.md)를 확인합니다.
...
| 문서 | 확인할 개념 |
| --- | --- |
| [데이터베이스와 RDBMS](../basic/01-database-rdbms.md) | DBMS, 테이블, 스키마, 키, NULL, 제약조건, SQLite |
| [SQL과 관계](../basic/02-sql-relations.md) | SQL, 관계, 정규화, JOIN, 집계, 트랜잭션 |
| [JSON과 MongoDB](../basic/03-json-mongodb.md) | JSON/BSON, 문서, 포함/참조, 배열, 커서, 인덱스 |
| [CRUD 비교](../basic/04-crud-comparison.md) | SQL·MongoDB CRUD, 결과 카운트, 연산자, 원자성, 테스트 |
