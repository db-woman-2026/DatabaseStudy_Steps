...
git status
npm pkg set "scripts.check=node --check index.js && node --check lib/mongodb.js && node --check lib/sampleBooks.js && node --check lib/bookInput.js" "scripts.test=node --test"
```
