...
내일은 review subdocument를 배열에 추가하고 aggregation 파이프라인으로 전체 재고, category, review를 요약합니다. Create/Read/Update/Delete를 한 시나리오로 완주하고 RDBMS와 문서 모델 선택 근거를 최종 설명합니다.
