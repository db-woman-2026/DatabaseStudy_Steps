...
| 문서 | 내용 | 연결 단계 |
| --- | --- | --- |
| [01. 데이터베이스와 RDBMS](./01-database-rdbms.md) | DBMS, 테이블, 스키마, 키, NULL, 제약조건, SQLite | `step-1` |
| [02. SQL과 관계](./02-sql-relations.md) | SQL, 키, 관계, 정규화, JOIN, 집계, 트랜잭션 | `step-2~3` |
| [03. JSON과 MongoDB](./03-json-mongodb.md) | JSON/BSON, 문서, 포함/참조, 배열, 커서, 인덱스 | `step-4~5` |
| [04. CRUD 비교](./04-crud-comparison.md) | SQL/MongoDB CRUD, 결과 카운트, 연산자, 삭제, 원자성, 테스트 | `step-6~8` |
